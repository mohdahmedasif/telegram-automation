...
async def generate_content_with_fallback(
    ...
    *,
    ...
    Each attempt is bounded by `request_timeout` — without this, a hung Gemini
    call blocks forever and (with `concurrent_updates(False)`) can freeze the
    whole bot for every chat, not just the one waiting on it.
    """
